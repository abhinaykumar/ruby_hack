...
describe BankAccount do
	...
	it "should initialize with a name" do
		bank_account = BankAccount.new("Aks")
		bank_account.name.must_equal 'Aks'
	end

	it "should have a trasactions" do
		subject.must_respond_to 'transactions'
	end

	it "should have an empty of transactions" do
	...
	describe "#deposit" do
		...
		it "responds to the deposit mehtod" do
